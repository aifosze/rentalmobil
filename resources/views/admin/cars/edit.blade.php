                    ...
                    <form action="{{ route('admin.cars.update', $car->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="bahan_bakar" id="bahan_bakar" class="form-control">
                                ...
                                <option {{ $car->bahan_bakar == 'solar' ? 'selected' : null }} value="solar">Solar</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="transmisi" id="transmisi" class="form-control">
                                ...
                                <option {{ $car->transmisi == 'matic' ? 'selected' : null }} value="otomatis">Matic</option>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.cars.updateImage', $car->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        @method('put')
                        <div class="form-group">
                            <img src="{{ Storage::url($car->gambar)}}" class="img-fluid">
                        </div>
                        <div class="form group">
